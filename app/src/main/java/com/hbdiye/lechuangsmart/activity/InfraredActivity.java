...
public class InfraredActivity extends BaseActivity {
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(InfraredActivity.this, text,
    ...
    private void onWifiChanged(WifiInfo info) {
        if (info == null) {
            ...
            if (mTask != null) {
                ...
                mTask = null;
                new AlertDialog.Builder(InfraredActivity.this)
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        private WeakReference<InfraredActivity> mActivity;
        ...
        EsptouchAsyncTask4(InfraredActivity activity) {
        ...
        protected List<IEsptouchResult> doInBackground(byte[]... params) {
            InfraredActivity activity = mActivity.get();
            int taskResultCount;
            synchronized (mLock) {
