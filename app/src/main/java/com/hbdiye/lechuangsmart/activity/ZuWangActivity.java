...
import com.hbdiye.lechuangsmart.utils.EspUtils;
...
public class ZuWangActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = "ZuWangActivity";
    ...
    protected int getLayoutID() {
        return R.layout.activity_zu_wang;
    }
    ...
    private void onWifiChanged(WifiInfo info) {
        if (info == null) {
            ...
            if (mTask != null) {
                ...
                mTask = null;
                new AlertDialog.Builder(ZuWangActivity.this)
                        .setMessage("Wifi断开连接或更改")
    ...
    public void onClick(View v) {
        if (v == mConfirmBtn) {
            if (TextUtils.isEmpty(mApPasswordET.getText().toString().trim())) {
                SmartToast.show("wifi密码不能为空");
                return;
            }
            if (TextUtils.isEmpty(mDeviceCountET.getText().toString().trim())) {
                SmartToast.show("数量不能为空");
                return;
            }
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                text = result.getBssid();
//                Toast.makeText(ZuWangActivity.this, text,
//                        Toast.LENGTH_LONG).show();
                sceneDialog = new SceneDialog(ZuWangActivity.this, R.style.MyDialogStyle, dailogClicer, "遥控中心名称");
     ...
     * @param bssid
     */
    private void addremote(String bssid,String name) {
        OkHttpUtils
                .post()
                .url(InterfaceManager.getInstance().getURL(InterfaceManager.ADDREMOTE))
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        private WeakReference<ZuWangActivity> mActivity;
        ...
        EsptouchAsyncTask4(ZuWangActivity activity) {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setMessage("设备配置中请稍候。。。");
        ...
        protected List<IEsptouchResult> doInBackground(byte[]... params) {
            ZuWangActivity activity = mActivity.get();
            int taskResultCount;
            synchronized (mLock) {
        ...
        protected void onPostExecute(List<IEsptouchResult> result) {
            ...
            if (result == null) {
                mResultDialog.setMessage("创建任务失败");
                mResultDialog.show();
                return;
            }
